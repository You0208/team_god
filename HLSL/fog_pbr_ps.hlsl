...
float4 main(VS_OUT pin) : SV_TARGET
{
    ...
    // 金属度
    float metallic = texture_maps[3].Sample(sampler_states[ANISOTROPIC], pin.texcoord).r;
    // 滑らかさ
    float smoothness = texture_maps[3].Sample(sampler_states[ANISOTROPIC], pin.texcoord).a;
    //// 調整
