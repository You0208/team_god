...
void EnemySpawner::Initialize()
{
	...
	timer = 0.0f;  // É^ÉCÉ}Å[
		//TODOÅ@Ç‡ÇÀ
	timer_speed = 10.0f;  // É^ÉCÉ}Å[ÇÃëÅÇ≠Ç∑ÇÈî{
	stage_to_shaft = 1.0f;  // ÉXÉeÅ[ÉWÇ∆é≤ÇÃó£ÇÍãÔçá
	shaft_pos = {};    // äeé≤ÇÃà íu
	stage_pos = { 0,0 };    // ÉXÉeÅ[ÉWà íuÇÃï€ë∂
	stage_width = { 5,5 };    // ÉXÉeÅ[ÉWïùÇÃï€ë∂
	...
	//TODO Ç‡ÇÀÅ@ìGÉXÉeÅ[É^ÉX
	{
		...
		enemy_A.speed_power = -1.3f;    // à⁄ìÆë¨ìx
		enemy_A.radius = 0.4f;			// îºåa
		...
		enemy_B.speed_power = -2.7f;	 // à⁄ìÆë¨ìx
		enemy_B.radius = 0.4f;			 // îºåa
		enemy_B.health = 4;				 // ëÃóÕ
		enemy_B.attack_effect_size = 0.3f;
		enemy_B.death_effect_size = 0.4f;
		enemy_B.hit_effect_size = 0.3f;
		mover_timer_max_B = 0.7f;		 // Ç∆Ç«Ç¡ÇƒÇ¢ÇÈéûä‘
		dis_B = 2.5f;					 // àÍãCÇ…êiÇﬁãóó£
		...
		enemy_D.speed_power = -1.2f;		 // à⁄ìÆë¨ìx
		enemy_D.radius = 0.4f;				 // îºåa
		...
		enemy_A_2.radius = 0.4f;			// îºåa
		enemy_A_2.health = 6;				// ëÃóÕ
		...
		enemy_B_2.radius = 0.4f;			 // îºåa
		enemy_B_2.health = 7;				 // ëÃóÕ
		...
		enemy_C_2.speed_power = -1.3f;		// à⁄ìÆë¨ìx
		enemy_C_2.radius = 0.4f;				// îºåa
		...
		enemy_D_2.speed_power = -1.79f;		 // à⁄ìÆë¨ìx
		enemy_D_2.radius = 0.4f;				 // îºåa
		...
		summon_enemy.attack_interval = 13.0f;		 // çUåÇä‘äu
		summon_enemy.speed_power = 0.0f;		 // à⁄ìÆë¨ìx
		summon_enemy.radius = 0.4f;				 // îºåa
		summon_enemy.health = 8;					 // ëÃóÕ
		...
		boss_enemy.speed_power = -0.9f;    // à⁄ìÆë¨ìx
...
void EnemySpawner::EnemySpawn(EnemyScript script)
{
	...
	case EnemyType::D:
		...
		if (script.shaft == Shaft::Side)// â°Ç©ÇÁèoÇƒÇ´ÇΩÇ∆Ç´ÇÃäpìx
			enemy->SetEasingValue(-90.0f);
		else if(script.shaft==Shaft::Vertical)// ècÇ©ÇÁèoÇƒÇ´ÇΩÇ∆Ç´ÇÃäpìx
	...
	case EnemyType::Summon:
	{
		...
		//TODO Ç‡ÇÀÅ@çUåÇä‘äuè¢ä´ìGÉXÉeÅ[ÉW
		switch (StageManager::Instance().GetStageLevel())
		{
		case 0:
...
void EnemySpawner::InitializeLevel1()
{
	...
	level_1.emplace_back(SetEnemy(170.0f, EnemyType::A, Shaft::Side, 15.0f));
	level_1.emplace_back(SetEnemy(170.0f, EnemyType::A, Shaft::Side, 17.0f));
...
void EnemySpawner::InitializeLevel5()
{
	...
	level_4.emplace_back(SetEnemy(36.0f, EnemyType::A, Shaft::Side, 8.0f));
	level_4.emplace_back(SetEnemy(36.0f, EnemyType::A, Shaft::Side, 7.0f));
	level_4.emplace_back(SetEnemy(36.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_4.emplace_back(SetEnemy(36.0f, EnemyType::A, Shaft::Side, 8.0f));
...
void EnemySpawner::InitializeLevel6()
{
	...
	level_6.emplace_back(SetEnemy(4.0f, EnemyType::B, Shaft::Side, 4.0f));//2
	...
	level_6.emplace_back(SetEnemy(11.0f, EnemyType::B, Shaft::Vertical, 12.0f));
	...
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::B, Shaft::Side, 8.0f));//5
	...
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::Nuisance, { -5, 6 }));
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::Nuisance, { -3, 6 }));
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::Nuisance, { 0, 6 }));
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::Nuisance, { 3, 6 }));
	level_6.emplace_back(SetEnemy(22.0f, EnemyType::Nuisance, { 6, 6 }));

	level_6.emplace_back(SetEnemy(26.0f, EnemyType::A, Shaft::Side, 10.0f));//5
	level_6.emplace_back(SetEnemy(26.0f, EnemyType::B, Shaft::Side, 11.0f));//5
	...
	level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -8, -6 }));
	level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -5, -6 }));
	level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 0, -6 }));
	level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 5, -6 }));
	level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 8, -6 }));
	...
	level_6.emplace_back(SetEnemy(51.0f, EnemyType::B, Shaft::Side, 17.0f));
	...
	level_6.emplace_back(SetEnemy(71.0f, EnemyType::B, Shaft::Vertical, 9.0f));
	...
	level_6.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { -7, -6 }));
	level_6.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { -8, -7 }));
	level_6.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { -7, -8 }));
	level_6.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { -6, -7 }));
	//level_6.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 8, -6 }));
	...
	level_6.emplace_back(SetEnemy(78.0f, EnemyType::Nuisance, { 7, 6 }));
	level_6.emplace_back(SetEnemy(78.0f, EnemyType::Nuisance, { 8, 7 }));
	level_6.emplace_back(SetEnemy(78.0f, EnemyType::Nuisance, { 7, 8 }));
	level_6.emplace_back(SetEnemy(78.0f, EnemyType::Nuisance, { 6, 7 }));
...
{
	level_7.emplace_back(SetEnemy(1.0f, EnemyType::B, Shaft::Vertical, 2.0f));
	//level_7.emplace_back(SetEnemy(1.0f, EnemyType::B, Shaft::Vertical, 4.0f));
	level_7.emplace_back(SetEnemy(1.0f, EnemyType::B, Shaft::Vertical, 6.0f));

	//level_7.emplace_back(SetEnemy(10.0f, EnemyType::B_2, Shaft::Vertical, 7.0f));
	//level_7.emplace_back(SetEnemy(3.0f, EnemyType::B_2, Shaft::Vertical, 9.0f));
	level_7.emplace_back(SetEnemy(10.0f, EnemyType::B_2, Shaft::Vertical, 11.0f));

	level_7.emplace_back(SetEnemy(12.0f, EnemyType::Nuisance, { 6, -7 }));
	level_7.emplace_back(SetEnemy(12.0f, EnemyType::Nuisance, { 6, -8.5 }));
	level_7.emplace_back(SetEnemy(12.0f, EnemyType::Nuisance, { 6, 7 }));
	level_7.emplace_back(SetEnemy(12.0f, EnemyType::Nuisance, { 6, 8.5 }));

	//level_7.emplace_back(SetEnemy(14.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	level_7.emplace_back(SetEnemy(15.0f, EnemyType::D, Shaft::Vertical, 9.0f));//1

	level_7.emplace_back(SetEnemy(16.0f, EnemyType::B, Shaft::Side, 3.0f));
	level_7.emplace_back(SetEnemy(17.0f, EnemyType::C_2, Shaft::Vertical, 6.0f));//2

	level_7.emplace_back(SetEnemy(19.0f, EnemyType::D, Shaft::Vertical, 9.0f));//1
	level_7.emplace_back(SetEnemy(24.0f, EnemyType::B, Shaft::Side, 14.0f));
	level_7.emplace_back(SetEnemy(30.0f, EnemyType::A, Shaft::Vertical, 17.0f));

	level_7.emplace_back(SetEnemy(31.0f, EnemyType::Nuisance, { -8, 2 }));
	level_7.emplace_back(SetEnemy(31.0f, EnemyType::Nuisance, { -8, 0 }));
	level_7.emplace_back(SetEnemy(31.0f, EnemyType::Nuisance, { -8, -2 }));


	level_7.emplace_back(SetEnemy(32.0f, EnemyType::A, Shaft::Side, 8.0f));
	//level_7.emplace_back(SetEnemy(32.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_7.emplace_back(SetEnemy(32.0f, EnemyType::A, Shaft::Side, 10.0f));//3

	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -8, 5 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -6, 4 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -4, 5 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { -2, 4 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 2, 5 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 4, 4 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 6, 5 }));
	level_7.emplace_back(SetEnemy(33.0f, EnemyType::Nuisance, { 8, 4 }));

	level_7.emplace_back(SetEnemy(35.0f, EnemyType::A, Shaft::Side, 8.0f));
	level_7.emplace_back(SetEnemy(35.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_7.emplace_back(SetEnemy(35.0f, EnemyType::A, Shaft::Side, 10.0f));//3

	level_7.emplace_back(SetEnemy(35.0f, EnemyType::B, Shaft::Vertical, 5.0f));
	level_7.emplace_back(SetEnemy(37.0f, EnemyType::B, Shaft::Vertical, 12.0f));

	level_7.emplace_back(SetEnemy(39.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(39.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4
	level_7.emplace_back(SetEnemy(41.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(41.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4
	level_7.emplace_back(SetEnemy(43.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4
	level_7.emplace_back(SetEnemy(43.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(45.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4
	level_7.emplace_back(SetEnemy(45.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(47.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4
	level_7.emplace_back(SetEnemy(47.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(49.0f, EnemyType::A, Shaft::Vertical, 17.0f));//4
	level_7.emplace_back(SetEnemy(49.0f, EnemyType::A, Shaft::Vertical, 4.0f));//4

	level_7.emplace_back(SetEnemy(52.0f, EnemyType::A_2, Shaft::Side, 15.0f));

	level_7.emplace_back(SetEnemy(55.0f, EnemyType::Nuisance, { -8, -8 }));
	level_7.emplace_back(SetEnemy(55.0f, EnemyType::Nuisance, { -8, -6 }));
	level_7.emplace_back(SetEnemy(55.0f, EnemyType::Nuisance, { -5, -8 }));
	level_7.emplace_back(SetEnemy(55.0f, EnemyType::Nuisance, { -5, -6 }));

	level_7.emplace_back(SetEnemy(55.0f, EnemyType::A, Shaft::Side, 6.0f));

	level_7.emplace_back(SetEnemy(60.0f, EnemyType::A, Shaft::Vertical, 2.0f));

	level_7.emplace_back(SetEnemy(61.0f, EnemyType::A, Shaft::Side, 16.0f));//4
	level_7.emplace_back(SetEnemy(63.0f, EnemyType::A, Shaft::Side, 16.0f));//4
	level_7.emplace_back(SetEnemy(65.0f, EnemyType::A, Shaft::Side, 16.0f));//4
	level_7.emplace_back(SetEnemy(67.0f, EnemyType::A, Shaft::Side, 16.0f));//4
	level_7.emplace_back(SetEnemy(69.0f, EnemyType::A, Shaft::Side, 16.0f));//4

	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { 0, 2 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { 0, -2 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { 2, 0 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { -2, 0 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { 2, -2 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { -2, 2 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { 2, 2 }));
	level_7.emplace_back(SetEnemy(70.0f, EnemyType::Nuisance, { -2, -2 }));

	level_7.emplace_back(SetEnemy(71.0f, EnemyType::A, Shaft::Side, 6.0f));//4
	level_7.emplace_back(SetEnemy(71.0f, EnemyType::A, Shaft::Vertical, 6.0f));//4
	level_7.emplace_back(SetEnemy(73.0f, EnemyType::A, Shaft::Side, 6.0f));//4
	level_7.emplace_back(SetEnemy(73.0f, EnemyType::A, Shaft::Vertical, 6.0f));//4
	level_7.emplace_back(SetEnemy(75.0f, EnemyType::A, Shaft::Side, 6.0f));//4
	level_7.emplace_back(SetEnemy(75.0f, EnemyType::A, Shaft::Vertical, 6.0f));//4
	level_7.emplace_back(SetEnemy(77.0f, EnemyType::A, Shaft::Side, 6.0f));//4
	level_7.emplace_back(SetEnemy(77.0f, EnemyType::A, Shaft::Vertical, 6.0f));//4
	level_7.emplace_back(SetEnemy(79.0f, EnemyType::A, Shaft::Side, 6.0f));//4
	level_7.emplace_back(SetEnemy(79.0f, EnemyType::A, Shaft::Vertical, 6.0f));//4

	level_7.emplace_back(SetEnemy(80.0f, EnemyType::Summon, { 2, 3 }));//5
	level_7.emplace_back(SetEnemy(80.0f, EnemyType::Summon, { 4, 6 }));//5


	level_7.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Side, 8.0f));
	level_7.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_7.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Side, 10.0f));//3

	//level_7.emplace_back(SetEnemy(52.0f, EnemyType::B, Shaft::Vertical, 15.5f));//6

	level_7.emplace_back(SetEnemy(54.0f, EnemyType::A, Shaft::Side, 8.5f));
	level_7.emplace_back(SetEnemy(54.0f, EnemyType::A, Shaft::Side, 9.5f));
	level_7.emplace_back(SetEnemy(54.0f, EnemyType::A, Shaft::Side, 10.5f));//3

	//level_7.emplace_back(SetEnemy(55.0f, EnemyType::B, Shaft::Vertical, 13.5f));//6

	level_7.emplace_back(SetEnemy(60.0f, EnemyType::A, Shaft::Side, 8.0f));
	level_7.emplace_back(SetEnemy(60.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_7.emplace_back(SetEnemy(60.0f, EnemyType::A, Shaft::Side, 10.0f));//3

	level_7.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { -3, 6 }));
	level_7.emplace_back(SetEnemy(73.0f, EnemyType::Nuisance, { 3, 6 }));

	level_7.emplace_back(SetEnemy(82.0f, EnemyType::B, Shaft::Vertical, 8.5f));//6
	level_7.emplace_back(SetEnemy(82.0f, EnemyType::B, Shaft::Vertical, 15.5f));//6

	level_7.emplace_back(SetEnemy(90.0f, EnemyType::B, Shaft::Vertical, 1.0f));
	level_7.emplace_back(SetEnemy(90.0f, EnemyType::A, Shaft::Side, 11.0f));

	level_7.emplace_back(SetEnemy(95.0f, EnemyType::A, Shaft::Vertical, 1.0f));
	//level_7.emplace_back(SetEnemy(95.0f, EnemyType::A, Shaft::Side, 1.0f));
	level_7.emplace_back(SetEnemy(96.0f, EnemyType::B, Shaft::Side, 4.0f));
	level_7.emplace_back(SetEnemy(96.0f, EnemyType::A, Shaft::Vertical, 9.0f));//5

	level_7.emplace_back(SetEnemy(110.0f, EnemyType::B, Shaft::Side, 8.0f));
	level_7.emplace_back(SetEnemy(110.0f, EnemyType::A, Shaft::Vertical, 1.0f));
	
}

void EnemySpawner::InitializeLevel8()
{
	level_8.emplace_back(SetEnemy(1.0f, EnemyType::A, Shaft::Side, 1.0f));
	level_8.emplace_back(SetEnemy(3.0f, EnemyType::A, Shaft::Side, 3.0f));
	level_8.emplace_back(SetEnemy(5.0f, EnemyType::A, Shaft::Side, 5.0f));
	level_8.emplace_back(SetEnemy(7.0f, EnemyType::A, Shaft::Side, 7.0f));
	level_8.emplace_back(SetEnemy(9.0f, EnemyType::A, Shaft::Side, 9.0f));

	level_8.emplace_back(SetEnemy(10.0f, EnemyType::Summon, { 0,0 }));
	...
	level_8.emplace_back(SetEnemy(15.0f, EnemyType::B_2, Shaft::Vertical, 17.0f));
	...
	level_8.emplace_back(SetEnemy(18.0f, EnemyType::A_2, Shaft::Side, 9.0f));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::A, Shaft::Vertical, 9.0f));

	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { -1,1 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { 1,1 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { -2,2 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { 2,2 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { -3,3 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { 3,3 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { -4,4 }));
	level_8.emplace_back(SetEnemy(20.0f, EnemyType::Nuisance, { 4,4 }));

	level_8.emplace_back(SetEnemy(20.0f, EnemyType::A_2, Shaft::Side, 11.0f));
	level_8.emplace_back(SetEnemy(22.0f, EnemyType::A, Shaft::Side, 13.0f));
	level_8.emplace_back(SetEnemy(24.0f, EnemyType::A, Shaft::Side, 15.0f));
	level_8.emplace_back(SetEnemy(26.0f, EnemyType::A_2, Shaft::Side, 17.5f));

	level_8.emplace_back(SetEnemy(26.0f, EnemyType::Summon, { 5,3 }));

	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -8 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -6 }));

	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, 8 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, 6 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, 4 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, 2 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -2 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -4 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -6 }));
	level_8.emplace_back(SetEnemy(30.0f, EnemyType::Nuisance, { -8, -8 }));
	...
	level_8.emplace_back(SetEnemy(31.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_8.emplace_back(SetEnemy(32.0f, EnemyType::A, Shaft::Side, 9.0f));
	level_8.emplace_back(SetEnemy(33.0f, EnemyType::A, Shaft::Side, 9.0f));


	level_8.emplace_back(SetEnemy(33.0f, EnemyType::A, Shaft::Side, 12.0f));
	level_8.emplace_back(SetEnemy(34.0f, EnemyType::A, Shaft::Side, 12.0f));
	level_8.emplace_back(SetEnemy(35.0f, EnemyType::A, Shaft::Side, 12.0f));


	level_8.emplace_back(SetEnemy(35.0f, EnemyType::A, Shaft::Side, 15.0f));
	level_8.emplace_back(SetEnemy(36.0f, EnemyType::A, Shaft::Side, 15.0f));
	level_8.emplace_back(SetEnemy(37.0f, EnemyType::A, Shaft::Side, 15.0f));

	level_8.emplace_back(SetEnemy(37.0f, EnemyType::C_2, Shaft::Side, 5.0f));
	level_8.emplace_back(SetEnemy(37.0f, EnemyType::D_2, Shaft::Vertical, 7.0f));
	level_8.emplace_back(SetEnemy(37.0f, EnemyType::B, Shaft::Vertical, 9.0f));

	level_8.emplace_back(SetEnemy(37.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	//level_8.emplace_back(SetEnemy(38.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	level_8.emplace_back(SetEnemy(39.0f, EnemyType::A, Shaft::Vertical, 3.0f));

	level_8.emplace_back(SetEnemy(39.0f, EnemyType::A, Shaft::Vertical, 6.0f));
	level_8.emplace_back(SetEnemy(40.0f, EnemyType::A, Shaft::Vertical, 6.0f));
	level_8.emplace_back(SetEnemy(41.0f, EnemyType::A, Shaft::Vertical, 6.0f));

	level_8.emplace_back(SetEnemy(41.0f, EnemyType::A, Shaft::Vertical, 9.0f));
	//level_8.emplace_back(SetEnemy(42.0f, EnemyType::A, Shaft::Vertical, 9.0f));
	level_8.emplace_back(SetEnemy(43.0f, EnemyType::A, Shaft::Vertical, 9.0f));

	level_8.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	//level_8.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Vertical, 5.0f));
	level_8.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Side, 5.0f));
	//level_8.emplace_back(SetEnemy(50.0f, EnemyType::A, Shaft::Side, 3.0f));//3

	level_8.emplace_back(SetEnemy(52.0f, EnemyType::Nuisance, { -7, -7 }));
	level_8.emplace_back(SetEnemy(52.0f, EnemyType::Nuisance, { -7, -5 }));

	level_8.emplace_back(SetEnemy(65.0f, EnemyType::D_2, Shaft::Vertical, 10.0f));
	level_8.emplace_back(SetEnemy(65.0f, EnemyType::A_2, Shaft::Vertical, 7.0f));
	level_8.emplace_back(SetEnemy(72.0f, EnemyType::A, Shaft::Side, 9.0f));//4
	level_8.emplace_back(SetEnemy(72.0f, EnemyType::C_2, Shaft::Side, 13.0f));//4

	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { -1,-1 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { 1,-1 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { -2,-2 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { 2,-2 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { -3,-3 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { 3,-3 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { -4,-4 }));
	level_8.emplace_back(SetEnemy(80.0f, EnemyType::Nuisance, { 4,-4 }));

	level_8.emplace_back(SetEnemy(80.0f, EnemyType::C_2, Shaft::Vertical, 11.0f));
	level_8.emplace_back(SetEnemy(82.0f, EnemyType::C_2, Shaft::Vertical, 13.0f));
	level_8.emplace_back(SetEnemy(84.0f, EnemyType::C_2, Shaft::Vertical, 15.0f));
	level_8.emplace_back(SetEnemy(86.0f, EnemyType::C_2, Shaft::Vertical, 17.5f));

	level_8.emplace_back(SetEnemy(92.0f, EnemyType::A, Shaft::Side, 1.0f));
	level_8.emplace_back(SetEnemy(92.0f, EnemyType::B_2, Shaft::Vertical, 1.0f));//6
	level_8.emplace_back(SetEnemy(95.0f, EnemyType::A, Shaft::Side, 1.0f));
	level_8.emplace_back(SetEnemy(95.0f, EnemyType::A_2, Shaft::Vertical, 1.0f));//6

	level_8.emplace_back(SetEnemy(100.0f, EnemyType::D_2, Shaft::Side, 16.0f));
	level_8.emplace_back(SetEnemy(100.0f, EnemyType::A_2, Shaft::Vertical, 15.0f));//7

	level_8.emplace_back(SetEnemy(109.0f, EnemyType::Nuisance, { 2, 0 }));
	level_8.emplace_back(SetEnemy(109.0f, EnemyType::Nuisance, { 0, 0 }));
	level_8.emplace_back(SetEnemy(109.0f, EnemyType::Nuisance, { -2, 0 }));

	level_8.emplace_back(SetEnemy(115.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	level_8.emplace_back(SetEnemy(120.0f, EnemyType::A, Shaft::Vertical, 8.0f));
	level_8.emplace_back(SetEnemy(120.0f, EnemyType::A, Shaft::Side, 10.0f));//8(3)

	level_8.emplace_back(SetEnemy(125.0f, EnemyType::A, Shaft::Side, 17.0f));
	level_8.emplace_back(SetEnemy(126.0f, EnemyType::B, Shaft::Vertical, 17.0f));//5

	level_8.emplace_back(SetEnemy(128.0f, EnemyType::A, Shaft::Vertical, 3.0f));
	level_8.emplace_back(SetEnemy(128.0f, EnemyType::A, Shaft::Vertical, 8.0f));
	level_8.emplace_back(SetEnemy(130.0f, EnemyType::A, Shaft::Side, 10.0f));//8(3)
}

void EnemySpawner::InitializeLevel9()
{
	level_9.emplace_back(SetEnemy(1.0f, EnemyType::B_2, Shaft::Vertical, 5.0f));
	...
	level_9.emplace_back(SetEnemy(11.0f, EnemyType::A_2, Shaft::Vertical, 10.0f));
	...
	level_9.emplace_back(SetEnemy(29.0f, EnemyType::D_2, Shaft::Side, 5.0f));
	level_9.emplace_back(SetEnemy(33.0f, EnemyType::C, Shaft::Side, 17.0f));
	level_9.emplace_back(SetEnemy(33.0f, EnemyType::A_2, Shaft::Vertical, 16.0f));//7
	...
	level_9.emplace_back(SetEnemy(46.0f, EnemyType::A_2, Shaft::Side, 8.0f));
	...
	level_9.emplace_back(SetEnemy(80.0f, EnemyType::C_2, Shaft::Side, 1.5f));//10
